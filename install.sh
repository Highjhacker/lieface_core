...
git clone "https://github.com/Highjhacker/lieface_core" "$HOME/core-token" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Highjhacker/lieface_core'"
    exit 1
fi
